...
function MyInfo() {
	...
	const {
		...
		formState: { isSubmitting: verificationIsSubmitting },
	} = useForm({
		defaultValues: {
			verificationCode: "",
		},
		...
		<div className={"pt-6 md:pt-10 md:pr-6"}>
			<div className={"w-full"}>
				...
				<div className="sm:p-6 md:p-0 lg:p-6 sm:border md:border-0 lg:border border-neutral3 w-full rounded-2xl mt-4">
					...
					<form onSubmit={handleSubmit1(onSubmit)} className={"flex flex-col"}>
					...
					{user.is_verified ? (
						...
						<form onSubmit={verificationHandleSubmit(verifyCodeHandler)} className="grid grid-cols-2 gap-x-6 gap-y-4">
