...
function FeatureOption({icon, title, description}) {
    return (
        <div className={'flex flex-col justify-center items-center'}>
            ...
            <h4 className={'font-medium md:font-semibold md:text-xl text-neutral12 mt-2 text-center'}>{title}</h4>
            <p className={'text-xs md:text-sm text-neutral10 text-center'}>{description}</p>
        </div>
    );
}
